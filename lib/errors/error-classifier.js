 ...
 * @returns {string} result.category - 'retryable' or 'non_retryable'
 * @returns {string} result.reason - Explanation for the classification
 * @returns {number} result.suggestedDelay - Suggested delay in ms before retry (if retryable)
 */
