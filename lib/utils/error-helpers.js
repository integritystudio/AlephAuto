 ...
 * @param {string} options.fallbackMessage - Fallback message for null/undefined errors
 ...
 * @param {boolean} options.includeType - Include error type in message
 * @param {boolean} options.includeCode - Include error code if available
