...
function logConfigStats(worker) {
...
function logScanTargets(worker) {
...
function attachJobEventListeners(worker) {
...
async function waitForJobsToComplete(worker) {
...
function logScanMetrics(worker) {
...
async function main() {
  ...
  try {
    ...
    logConfigStats(worker);
    logScanTargets(worker);

    console.log('▶️  Running test scan...\n');

    attachJobEventListeners(worker);

    await worker.runNightlyScan();

    console.log('⏳ Waiting for jobs to complete...\n');

    await waitForJobsToComplete(worker);

    console.log('╔══════════════════════════════════════════════════════════╗');
    console.log('║                   TEST COMPLETED                         ║');
    console.log('╚══════════════════════════════════════════════════════════╝\n');

    logScanMetrics(worker);
