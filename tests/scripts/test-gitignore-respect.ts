...
async function runGitignoreTest(outputDir: string, testDir: string) {
...
function runAdditionalPatternsTest(outputDir: string) {
...
async function testGitignoreRespect() {
  ...
  try {
    ...
    await runGitignoreTest(outputDir, testDir);
    runAdditionalPatternsTest(outputDir);
