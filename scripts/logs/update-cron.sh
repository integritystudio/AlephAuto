...
0 2 * * * /bin/bash /Users/alyshialedlie/code/jobs/scripts/logs/log-cleanup.sh >> /Users/alyshialedlie/code/jobs/logs/cleanup-logs/cron-output.log 2>&1
# Weekly summary - runs every Monday at 3:00 AM
0 3 * * 1 /bin/bash /Users/alyshialedlie/code/jobs/scripts/logs/weekly-log-summary.sh >> /Users/alyshialedlie/code/jobs/logs/cleanup-logs/cron-output.log 2>&1
EOF
