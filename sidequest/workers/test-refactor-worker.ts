...
`;
  ...
  generateConstantsContent(hardcodedStrings: string[]): string {
    ...
    sections.push(this.generateArrayExport('NAV_STRINGS', categories.navigation, 'Navigation labels'));
    sections.push(this.generateArrayExport('ACTION_STRINGS', categories.actions, 'Button and action labels'));
    sections.push(this.generateArrayExport('A11Y_STRINGS', categories.accessibility, 'Accessibility labels'));
    sections.push(this.generateArrayExport('MESSAGE_STRINGS', categories.messages, 'User-facing messages'));
    sections.push(this.generateArrayExport('HEADING_STRINGS', categories.headings, 'Headings and titles'));
    sections.push(this.generateArrayExport('LABEL_STRINGS', categories.labels, 'Form field labels'));
    sections.push(this.generateArrayExport('MISC_STRINGS', categories.misc, 'Other extracted strings'));
