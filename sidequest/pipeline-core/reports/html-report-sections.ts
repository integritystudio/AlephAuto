...
export function isInterProject(scanResult: ScanResult): boolean {
  return scanResult.scan_type === 'inter-project';
}

function formatScanTimestamp(scanResult: ScanResult): string {
  return formatTimestamp(scanResult.scan_metadata?.scanned_at);
}
  ...
  return `
    <header>
        ...
        <div class="header-meta">
            ...
            <span class="meta-item">
                <strong>Date:</strong> ${formatScanTimestamp(scanResult)}
            </span>
            <span class="meta-item">
...
export function generateFooter(scanResult: ScanResult): string {
  return `
    <footer>
        <p>Generated by Duplicate Detection Pipeline | ${formatScanTimestamp(scanResult)}</p>
    </footer>`;
}
